...
# Generated COMSOL models are kept under workspace to avoid root clutter.
MODELS_BASE_DIR = Path(__file__).parent.parent.parent / "workspace" / "models"
...
def generate_version_path(model_name: str, base_path: str = None) -> str:
    ...
    Uses structured path: ./workspace/models/{model_name}/{model_name}_{timestamp}.mph
...
def generate_latest_path(model_name: str) -> str:
    ...
    Uses structured path: ./workspace/models/{model_name}/{model_name}_latest.mph
